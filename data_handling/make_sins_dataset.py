# make_sines_dataset.py
# Generate a 5-D sine dataset with 24-step windows, like Diffusion-TS (sines.yaml).
# Saves:
#   sines_ground_truth_24_train.npy, sines_ground_truth_24_test.npy
#   sines_norm_truth_24_train.npy,  sines_norm_truth_24_test.npy
#   sines_scale_24.npz   (train feature-wise mins & maxs)
#
# You fill: OUT_DIR (where to save files)
...
# -----------------------------
# Config (match Diffusion-TS sizes from sines.yaml)
# -----------------------------
...
# (Defaults chosen to produce varied, nontrivial 5-D signals.)
# If you get the exact ranges from Diffusion-TS SineDataset, plug them here.
# -----------------------------
